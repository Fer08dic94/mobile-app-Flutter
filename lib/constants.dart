...
const String kInvalidEmailError = "Por favor ingresa un correo valido";
const String kPassNullError = "Por favor ingresa una contraseña";
const String kShortPassError = "La contraseña es muy corta";
const String kMatchPassError = "La contraseña no conincide";
const String kNamelNullError = "Por favor ingresa tu nombre";
const String kPhoneNumberNullError = "Por favor ingresa un número de telefono";
